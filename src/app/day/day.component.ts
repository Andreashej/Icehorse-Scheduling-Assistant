...
//       this.blocks[venue.venue_id] = [];
//       this.busyUntil[venue.venue_id] = -1;
//     }
...
//         vBlock.busyUntil = this.busyUntil[venue.venue_id];
        
//         if (this.busyUntil[venue.venue_id] >= i) {
//           this.blocks[venue.venue_id].push(vBlock);
//           continue;
//         }
